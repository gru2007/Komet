                  ...
                  children: [
                    ...
                    if (theme.useCustomChatWallpaper) ...[
                      ...
                      if (theme.chatWallpaperType ==
                        ...
                        if (theme.chatWallpaperImagePath?.isNotEmpty ==
                            true) ...[
                          _SliderTile(
                            icon: Icons.blur_on,
                            label: "Размытие",
                      ...
                      if (theme.chatWallpaperType ==
                        ...
                        if (theme.chatWallpaperVideoPath?.isNotEmpty ==
                            true) ...[
                          _ActionTile(
                            icon: Icons.delete_outline,
                            title: "Удалить видео",
                    ...
                    _ExpandableSection(
                      ...
                      children: [
                        ...
                        _SliderTile(
                          ...
                          displayValue: theme.messageMenuBlur.toStringAsFixed(
                            1,
                          ),
                        ),
                        _SliderTile(
                    ...
                    _ExpandableSection(
                      ...
                      children: [
                        _SliderTile(
                          ...
                          displayValue:
                              "${theme.messageBorderRadius.round()}px",
                        ),
                        const SizedBox(height: 16),
                        _CustomSettingTile(
                ...
                _ExpandableSection(
                  ...
                  children: [
                    _SliderTile(
                      ...
                      divisions: 20,
                      onChanged: (value) =>
                          theme.setProfileDialogOpacity(value),
                      displayValue:
              ...
              children: [
                ...
                _CustomSettingTile(
                  ...
                  child: DropdownButton<ChatsListBackgroundType>(
                    ...
                    onChanged: (value) {
                      if (value != null)
                        theme.setChatsListBackgroundType(value);
                    },
                ...
                _CustomSettingTile(
                  ...
                  subtitle:
                      "Выберите тип фона для AppBar (поиск, Сферум и т.д.)",
                ...
                _CustomSettingTile(
                  ...
                  child: DropdownButton<FolderTabsBackgroundType>(
                    ...
                    onChanged: (value) {
                      if (value != null)
                        theme.setFolderTabsBackgroundType(value);
                    },
                ...
                _ExpandableSection(
                  ...
                  children: [
                    ...
                    _SliderTile(
                      ...
                      displayValue:
                          "${(theme.bottomBarOpacity * 100).round()}%",
                    ),
                    _SliderTile(
